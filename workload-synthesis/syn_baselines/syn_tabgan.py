...
# Function to train the TabGAN model with diversity-promoting adjustments
def train_tabgan(generator, discriminator, train_data, val_data, num_epochs=50, batch_size=100, lr=0.0002, lambda_gp=10):
...
# Normalize the data (fit scaler only on training data)
scaler = StandardScaler()
train_data_scaled = scaler.fit_transform(train_data)
val_data_scaled = scaler.transform(val_data)
...
# Train TabGAN with diversity-promoting adjustments
